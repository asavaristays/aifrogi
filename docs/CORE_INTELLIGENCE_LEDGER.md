...
| `CI-023` | Answer-path context priority, claim equivalence and replay trace | `LIVE` | Every governed website bot | `lib/sovereign-intelligence/answer-context.ts`, claim validator, conversation planner and website knowledge runtime | Release `c614c9b`: guarantees the best approved page, limits deep context to explicit entities, keeps fresh capability questions independent, normalizes numeric equivalence, validates explicit entitlements, and records answer replay traces. Final evidence passed focused 7/7, TypeScript, Sovereign 384/384, production-hardening 126/126, complete production-derived 89-route build, Core 30/30, fleet Golden 3/3, first-ten security and repeated ten-answer Asavaristays review. Public live/ready and embed checks passed; TypeSafe remained off and the promoted hashes matched the candidate. Rollback: `/var/backups/aifrogi/ci023-core-recovery-c614c9b-20260923`. |
