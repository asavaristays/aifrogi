...
| `CI-023` | Answer-path context priority, claim equivalence and replay trace | `LOCAL` | Every governed website bot | `lib/sovereign-intelligence/answer-context.ts`, claim validator, conversation planner and website knowledge runtime | The highest-ranked approved page is guaranteed context, broad entity facts require an explicit entity, fresh capability questions cannot inherit unrelated operation slots, equivalent percent spacing is normalized, unsupported free/included claims are blocked, and proposed/final answers are captured in a replay trace. Local focused tests passed 10/10, TypeScript, Sovereign 381/381, channels 232/232, production-hardening 126/126 and the 91-page webpack build. The production-derived candidate passed TypeScript, its complete 89-route build, Core 30/30 and fresh Golden certification for all 3/3 live tenants. The current Golden records validate governed dispositions but do not retain answer text, and Asavaristays' bank omits the observed rate, parking, general online-booking and cancellation regressions; an answer-text replay remains required before deployment. |
