...
| `CI-007` | Human handover and tenant Team Inbox | `PILOT_EVIDENCE` | Bots with handover enabled | website handover, response SLA, Team Inbox | Persistence and client visibility are live; visitor recovery into a separate fresh AI conversation is implemented locally and awaits deployment. Operating response quality requires pilot evidence. |
