...
| `CI-023` | Answer-path context priority, claim equivalence and replay trace | `LOCAL` | Every governed website bot | `lib/sovereign-intelligence/answer-context.ts`, claim validator, conversation planner and website knowledge runtime | Guarantees the best approved page, limits deep context to explicit entities, keeps fresh capability questions independent, normalizes numeric equivalence, validates explicit entitlements, and records answer replay traces. Final local checks passed focused 7/7, TypeScript, Sovereign 384/384 and production-hardening 126/126. The exact production-derived candidate passed its complete 89-route build, Core 30/30, fleet Golden 3/3, first-ten security, and the repeated ten-answer Asavaristays review. Unsupported free parking was withheld; negated breakfast wording and cancellation percentages remained answerable. Ready for a separate deployment decision. |
