...
| `TI-011` | Per-bot Flow Intelligence templates and Main Menu publishing | `LOCAL` | Per tenant bot | `/flow-intelligence`, tenant settings, website widget Main Menu | Functional builder release `ti011-visual-builder-20260909` is live. Graphical refinement with draggable coloured nodes, curved connectors, zoom and sliding panels is implemented locally and awaits deployment. |
