...
test("saved review evidence does not bypass certification", () => { const reviewed = record({ runAt: null, passed: false, review: { reviewedBy: "owner@example.com", reviewerRole: "OWNER", reviewedAt: "2026-09-14T00:00:00Z", caseCount: 10, sourceRevision: "rev-1", approvalStatement: "Reviewed" } }); assert.equal(tenantCertificationStatus(reviewed, "rev-1").eligible, false); });
