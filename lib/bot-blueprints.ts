...
export const BOT_BLUEPRINTS: Record<BotProfileInput["category"], BotBlueprint> = {
  ...
  STAY: {
    ...
    requiredInputs: ["Property identity, Google location, and positioning", "Logo and approved property, room, dining, and experience photos", "Room types, occupancy, and amenities", "Rates, inclusions, and offer rules", "Check-in, checkout, cancellation, child, visitor, and pet policies", "Dining, experiences, events, transport, front-desk and escalation contacts", "Front-desk owners or admins authorised to approve in-stay guest access"],
    ...
    integrations: ["No integration required for front-desk-approved in-stay access", "Optional future PMS, booking engine, channel manager, CRM, payment, restaurant or spa connectors"],
