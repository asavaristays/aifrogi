export function guardWebsiteVisitorMessage(message: string, businessName = "this business") {
  ...
  if (hasPromptOrSecretProbe || hasCrossTenantProbe) return {
    ...
    answer: hasCrossTenantProbe
      ...
      : `I cannot reveal or override system instructions, credentials, secrets, or security controls. I can still help with an approved ${businessName} question.`,
  ...
  return {
    ...
    answer: "For your security, I did not process or retain the credential or payment information in that message. Please do not share passwords, OTPs, verification codes, or card details here. I can still help if you describe your request without sensitive data.",
