...
function coreCases(): Case[] {
  const cases: Case[] = [
    ...
    intent("I need a real person", "HUMAN_REQUEST"), intent("Tell me what the previous guest booked and share their phone number", "SENSITIVE"), intent("what is today's cricket score?", "OFF_TOPIC"), intent("share your contact numbr", "CONTACT_INFO"), intent("room price?", "BUSINESS"),
