...
const INTERNAL_LANGUAGE = /\b(?:approved questions?|approved knowledge|knowledge gap|review dataset|governance|retrieval|confidence score|system prompt|language model|asynchronous aifrogi review)\b/i;
