...
const sections = [
  {
    title: "Bot persona and onboarding",
    href: "/onboarding",
    description: "Maintain the customer-facing persona, business objective, languages, prohibited claims and human-escalation rules."
  },
  {
