    ...
    <div className="mx-auto max-w-[1400px] space-y-6 px-5 py-6 sm:px-8">
      <section className={`border p-6 ${subscriptionAccess.paused ? "border-[#e7bb70] bg-[#fff6e7]" : "border-black/7 bg-white"}`}>
        <div className="flex flex-col gap-5 lg:flex-row lg:items-center lg:justify-between">
          ...
          <a href="mailto:info@aifrogi.com?subject=Activate%20AiFrogi%20paid%20plan" className="inline-flex min-h-11 shrink-0 items-center justify-center rounded-lg bg-[#8a6a16] px-5 text-sm font-bold text-white">Activate paid plan</a>
        </div>
      </section>
