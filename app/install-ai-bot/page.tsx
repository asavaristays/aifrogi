...
export default function InstallAiBotPage() {
  return <main className="bg-[#fbfaf7] text-[#101010]"><SiteHeader />
    ...
    <section className="px-5 py-16 sm:px-8 sm:py-24"><div className="mx-auto max-w-7xl">
      <div className="grid gap-6 lg:grid-cols-[.72fr_1.28fr] lg:items-end"><div><p className="product-eyebrow">Connector guide</p><h2 className="mt-3 text-4xl font-semibold tracking-[-.04em] sm:text-5xl">Know what your bot needs before live actions.</h2></div><div><p className="max-w-2xl text-base leading-7 text-[#68645c]">Every bot can begin with approved business knowledge and human handover. A connector is required only when the bot must read live information or confirm an action in another system.</p><Link href="/downloads/AiFrogi-AI-Bot-Connector-and-Installation-Guide.pdf" download className="dark-primary-action mt-5 inline-flex min-h-12 items-center justify-center gap-3 rounded-md bg-[#101010] px-6 text-sm font-semibold"><span aria-hidden="true">↓</span> Download connector guide (PDF)</Link><Link href="/downloads/AiFrogi-Connector-Requirements-and-Charges.pdf" download className="mt-3 block text-sm font-semibold underline underline-offset-4">↓ Connector requirements & charges (PDF)</Link></div></div>
