...
export default function KnowledgePreviewPage() {
  ...
  ], propertyId: "preview", documents: [{ id: "doc-1", fileName: "AI operations and pricing.pdf", mimeType: "application/pdf", sizeBytes: 248000, status: "PENDING", conflictSummary: null, uploadedBy: "support@hotelradar.in", approvedBy: null, createdAt: crawledAt, updatedAt: crawledAt }], entries: [{ id: "entry-1", question: "What is included in the 15-day trial?", answer: "The trial includes a working setup review, one agreed workflow, and guided onboarding. Final scope is confirmed before activation.", category: "Pricing and trial", status: "APPROVED", conflictSummary: null, createdBy: "support@hotelradar.in", approvedBy: "support@hotelradar.in", createdAt: crawledAt, updatedAt: crawledAt }], gaps: [{ id: "gap-1", question: "Can this connect with our existing booking system?", occurrenceCount: 4, status: "OPEN", lastAskedAt: crawledAt }] }} /></AppShell>;
}
