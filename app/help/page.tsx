...
export default function HelpCenterPage() {
  return <main className="min-h-screen bg-white text-[var(--text)]">
    ...
    <section className="border-b border-white/10 bg-[#101010] px-5 py-16 text-white sm:px-8 sm:py-20">
      <div className="mx-auto max-w-7xl"><p className="text-xs font-bold uppercase tracking-[.16em] text-[#e2c66d]">AiFrogi Resource Center</p><h1 className="mt-4 max-w-3xl text-4xl font-semibold tracking-[-.04em] sm:text-5xl">Answers that move the work forward.</h1><p className="mt-5 max-w-2xl text-base leading-7 text-white/62">Short, practical guidance for website setup, AI knowledge, access, and support.</p></div>
    </section>
