  ...
  return (
    ...
    >
      ...
      <LegalSection title="7. Suspension and termination">
        <p>We may restrict or suspend access for security threats, unlawful activity, material policy violations, non-payment, or conduct that risks the service or third-party platforms. You may stop using the service and request account closure.</p>
      </LegalSection>
