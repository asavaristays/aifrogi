    ...
    <main className="bg-white text-[var(--ink-900)]">
      ...
      <section className="overflow-hidden bg-[var(--warm-25)] px-5 py-16 sm:px-8 sm:py-24">
        <div className="mx-auto max-w-7xl">
          ...
          {product.slug === "hotelgpt" ? <div className="mt-10 flex flex-col gap-5 rounded-xl border border-[#d8c278] bg-[#fff9e8] p-6 sm:flex-row sm:items-center sm:justify-between"><div><p className="product-eyebrow">Hotel knowledge checklist</p><h3 className="mt-2 text-2xl font-semibold">Complete verified hotel details after the website crawl.</h3><p className="mt-2 max-w-2xl text-sm leading-6 text-[var(--text-muted)]">The workbook covers rooms, rates, policies, amenities, transport, weddings, payments and safe human handover. Completed answers remain subject to review before publishing.</p></div><div className="flex shrink-0 flex-col gap-3 sm:items-stretch"><a href="/downloads/AiFrogi-HotelGPT-Knowledge-Onboarding.xlsx" download className="inline-flex min-h-12 items-center justify-center rounded-md bg-[var(--gold-600)] px-6 text-sm font-bold text-[var(--ink-600)]">Download HotelGPT Excel</a><a href="https://app.aifrogi.com/login?returnTo=%2Fknowledge" className="inline-flex min-h-12 items-center justify-center rounded-md border border-black/15 bg-white px-6 text-sm font-bold text-[var(--ink-600)]">Sign in to upload</a></div></div> : null}
        </div>
      </section>
