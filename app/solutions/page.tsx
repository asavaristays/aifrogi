      ...
      <section className="px-5 py-20 sm:px-8">
        <div className="mx-auto grid max-w-7xl gap-12 lg:grid-cols-[.86fr_1.14fr] lg:items-center">
          <div>
            ...
            <p className="mt-6 max-w-2xl text-lg leading-8 text-[#70697d]">
            ...
            <p className="mt-8 text-sm font-semibold text-[#c725ba]">
              Broadcast | Chatbot | Retarget | Order | Pay | Remind | Review | Book
            </p>
          </div>
          <div className="grid gap-4">
            <Link href="/solutions/flowcart" className="group rounded-lg border border-black/8 bg-[#f8f4ed] p-6 shadow-[0_22px_70px_rgba(44,36,59,.1)]">
            ...
            <Link href="/solutions/pingbook" className="group rounded-lg border border-black/8 bg-[#fbf8fc] p-6 shadow-[0_22px_70px_rgba(44,36,59,.1)]">
              <div className="grid gap-6 sm:grid-cols-[180px_1fr] sm:items-center">
                <div className="rounded-lg border border-black/8 bg-white p-4">
                  <Image src="/brand/pingbook-logo-aifrogi-tight.png" alt="PingBook" width={1200} height={1200} className="h-auto w-full" />
                </div>
                <div>
                  <p className="text-xs font-bold text-[#b923ae]">Appointment solution</p>
                  ...
                  <span className="mt-5 inline-flex items-center gap-2 text-sm font-bold text-[#b923ae]">
                    Open PingBook
                    <Icon name="arrow-right" className="transition-transform group-hover:translate-x-1" />
                  </span>
                </div>
