...
export default function SecurityCompliancePage() {
  return (
    <main className="bg-white text-[var(--ink-900)]">
      ...
      <section className="border-y border-black/8 bg-black px-5 py-16 text-white sm:px-8 sm:py-20">
        <div className="mx-auto grid max-w-7xl gap-8 lg:grid-cols-[1fr_auto] lg:items-center"><div><p className="product-eyebrow text-[var(--gold-300)]">Customer verification</p><h2 className="mt-3 text-3xl font-semibold tracking-[-.035em] sm:text-4xl">Test the controls without exposing production data.</h2><p className="mt-4 max-w-3xl text-base leading-7 text-white/60">Qualified customers and independent assessors can review architecture, test two isolated staging tenants, verify role refusals, rotate or revoke a synthetic connector credential, submit forged payment evidence and inspect sanitized recovery records.</p></div><a href="mailto:info@aifrogi.com?subject=AiFrogi%20Security%20Review" className="inline-flex min-h-12 items-center gap-2 rounded-lg bg-[#8a6a16] px-5 text-sm font-bold text-white">Request a security review <Icon name="arrow-right" /></a></div>
      </section>
      <SiteFooter />
    </main>
  );
