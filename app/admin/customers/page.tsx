        ...
        <div className="overflow-x-auto">
          <table className="w-full min-w-[900px] border-collapse text-left text-sm">
            <thead className="bg-[#f7faf8] text-xs uppercase tracking-[0.12em] text-[#6d7487]">
              <tr><th className="px-5 py-4">Company</th><th className="px-5 py-4">Phone</th><th className="px-5 py-4">Business KYC</th><th className="px-5 py-4">WhatsApp</th><th className="px-5 py-4">Plan</th><th className="px-5 py-4 text-right">Action</th></tr>
            </thead>
            <tbody className="divide-y divide-black/5">
              {organizations.map((organization) => (
                <tr key={organization.id}>
                  ...
                  <td className="px-5 py-4">{organization.plan}</td>
              ...
              {!organizations.length ? <tr><td className="px-5 py-10 text-center text-[#6d7487]" colSpan={6}>No customer organizations yet.</td></tr> : null}
            </tbody>
          </table>
        </div>
      </section>
