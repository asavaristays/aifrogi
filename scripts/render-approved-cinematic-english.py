...
for t,im in footage('hotel.mp4',13,rate=15/13):
 stage=min(3,int(t/3.25));caps=['Choose your dates.','Explore available rooms.','Review your details.','Your room booking, confirmed.']
 write(chrome(english_hotel(im,t),caps[stage],'HotelGPT · Room booking journey'));last=im
