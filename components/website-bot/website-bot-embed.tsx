...
import { Headset, LayoutGrid, MessageCircle, ArrowUp, X } from 'lucide-react';
...
export function WebsiteBotEmbed({ slug, demo = false, botName = "AI Business Assistant", welcomeMessage = "Hello. How can I help with your business enquiry today?", themeColor = "#8a6a16", widgetTheme = "dark", logoUrl = "", welcomeCardImageUrl = "", welcomeCardTitle = "", welcomeCardText = "", dismissible = false, menu = { enabled: false, heading: "", items: [] } }: { slug: string; demo?: boolean; botName?: string; welcomeMessage?: string; themeColor?: string; widgetTheme?: "dark" | "light" | "system"; logoUrl?: string; welcomeCardImageUrl?: string; welcomeCardTitle?: string; welcomeCardText?: string; dismissible?: boolean; menu?: WidgetMenuConfig }) {
