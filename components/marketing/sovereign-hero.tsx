    ...
    <div className="relative mx-auto grid max-w-7xl items-center gap-8 lg:grid-cols-[1.12fr_.88fr] lg:gap-5">
      <div className="relative z-10 text-center lg:text-left">
        ...
        <div className="mt-8 flex flex-wrap justify-center gap-3 lg:justify-start">
          ...
          <a href="/solutions" className="inline-flex min-h-12 items-center gap-2 rounded-md border border-white/15 bg-white/5 px-6 text-sm font-semibold text-white/76 transition hover:border-[var(--gold-300)]/45 hover:bg-white/10 hover:text-white">Explore business bots</a>
        </div>
      </div>
