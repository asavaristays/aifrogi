...
import { PingBookPricingCalculator } from "@/app/solutions/pingbook/pricing-calculator";

const pricingCards = [
  { title: "One-time setup", price: "Rs. 4,500", copy: "Meta, Razorpay, and Google onboarding with one clinic booking test." },
  { title: "PingBook platform", price: "Rs. 1,250 / mo", copy: "Paid quarterly at Rs. 3,750 with a 15-day cancellation and refund window." },
  { title: "Meta message fee", price: "As used", copy: "Billed by delivered WhatsApp message category and customer country." }
];

export function PingBookPricingSection() {
  return (
    <section id="pingbook-pricing" className="border-t border-black/8 bg-white px-5 py-16 sm:px-8 sm:py-20">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-10 lg:grid-cols-[0.76fr_1.24fr] lg:items-start">
          <div>
            <p className="product-eyebrow">PingBook pricing example</p>
            ...
            <a href="https://app.aifrogi.com/register?source=whatsapp-api-pingbook-pricing" className="mt-7 inline-flex min-h-12 items-center gap-2 rounded-lg bg-[var(--gold-600)] px-6 text-sm font-bold text-[var(--ink-600)] transition hover:bg-[var(--gold-500)]">Start with Rs. 4,500 setup <Icon name="arrow-right" /></a>
          </div>
          <div>
