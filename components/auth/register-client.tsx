    ...
    <main className="min-h-screen bg-[#fbfaf7] text-[#101010]">
      <header className="border-b border-[#ded8cb] bg-white px-5 sm:px-8">
        <div className="mx-auto flex h-16 max-w-7xl items-center justify-between">
          <Link href="https://aifrogi.com"><Image src="/brand/aifrogi-logo.png" alt="AiFrogi" width={800} height={300} priority className="h-auto w-[150px] grayscale contrast-125" /></Link>
          <Link href="/login" className="text-sm font-semibold text-[#6d5310]"><span className="hidden sm:inline">Already have an account? </span>Sign in</Link>
        </div>
      </header>
