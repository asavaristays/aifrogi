...
export function KnowledgeWorkspace({
  ...
  async function saveEntry(event: FormEvent) {
    ...
    try {
      ...
      setNotice(editingEntryId ? (payload.result?.createdVersion ? "Edited answer saved as a new draft. The prior approved version remains recorded until you approve the replacement." : "Draft answer updated. Review and approve it when ready.") : payload.entry.status === "CONFLICT" ? "Answer saved with a possible conflict. Review it before approval." : "Answer saved as a draft. Approve it when ready.");
