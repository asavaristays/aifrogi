    ...
    <div className="space-y-6">
      ...
      <section id="new-support-request" className="h-fit scroll-mt-24 rounded-lg border border-black/6 bg-white p-6 shadow-sm xl:sticky xl:top-24">
        ...
        <div className="mt-5 grid gap-4">
          <label><span className="field-label">Category</span><select className="product-input mt-2" value={category} onChange={(event) => setCategory(event.target.value)}><option value="AI_BOT">AI Bot answer or behaviour</option><option value="KNOWLEDGE">Knowledge and content</option><option value="CONNECTOR">Connector or action</option><option value="ONBOARDING">Onboarding and installation</option><option value="BILLING">Billing and plan</option><option value="ACCOUNT">Account access</option><option value="OTHER">Other</option></select></label>
