...
export function BotProfileConfigurator({ initialProfile, organizationId, compact = false, websiteOnly = true, onSaved }: { initialProfile?: StoredProfile | null; organizationId?: string; compact?: boolean; websiteOnly?: boolean; onSaved?: (organization: unknown) => void }) {
  ...
  function setCategory(category: BotProfileInput["category"]) {
    ...
    setProfile((current) => ({ ...current, category, operatingMode: pack.defaultOperatingMode, capabilities: [...pack.defaultCapabilities], personaName: pack.defaultPersonaName, businessObjective: categoryBlueprint.promise, tone: pack.tone, prohibitedClaims: [...categoryBlueprint.safetyRules], escalationTriggers: [...pack.hardEscalations] }));
  }
