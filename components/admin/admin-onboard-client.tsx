...
export function AdminOnboardClient() {
  ...
  return <form onSubmit={submit} className="grid gap-7 xl:grid-cols-[1.05fr_.95fr]">
    ...
    <section className="border border-white/70 bg-white p-6 sm:p-8">
      <p className="product-eyebrow">Step 2 · Create workspace</p><h2 className="mt-3 text-3xl font-semibold tracking-[-.04em]">Add the pilot owner.</h2><p className="mt-3 text-sm leading-6 text-[#68645c]">This starts the AI Bot onboarding track for knowledge, persona, testing and publishing.</p>
