...
type Item = { id: string; guestName: string; phoneNumber: string; roomNumber: string; requestedCheckIn: string; requestedCheckOut: string; approvedCheckOut: string | null; status: string; createdAt: string };
