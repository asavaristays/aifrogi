...
export async function InStaySectionPage({ view }: { view: View }) {
  ...
  return <div className="min-h-screen bg-[var(--background)]"><TopBar title="In-stay" subtitle="Guest service operations"/><div className="px-4 py-6 sm:px-6 lg:px-8"><InStayWorkspace propertySlug={property.slug} view={view}/></div></div>;
}
