...
export function WhatsAppBotClient({
  ...
  const displayedParty = hotelMode && activeLead.party === "Service requirement pending" ? "Stay dates and guest count pending" : activeLead.party;
