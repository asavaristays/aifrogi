...
type StayCase = { id:string; kind:"QUERY"|"COMPLAINT"; status:"NEW"|"IN_PROGRESS"|"RESOLVED"; priority:"URGENT"|"NORMAL"; latestMessage:string; department?:string; owner?:string|null; slaState?:"ON_TRACK"|"DUE_SOON"|"OVERDUE"|"MET" };
